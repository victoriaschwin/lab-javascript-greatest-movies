...
function howManyMovies(moviesArray) {
  ...
  let dramaMovies = filteredArr.filter((movie) =>
...
function scoresAverage(moviesArray) {
  ...
  let avg = scoresArr.reduce(
    (startScore, finalScore) => startScore + finalScore
  );

  return (avg / scoresArr.length).toFixed(2);
}
...
function turnHoursToMinutes(moviesArray) {
  ...
  newMovies.map((movie) => {
    ...
    console.log(typeof durationInMin);
